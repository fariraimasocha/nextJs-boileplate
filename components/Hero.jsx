  ...
  return (
    <section className="container flex min-h-[calc(100vh-3.5rem)] max-w-screen-2xl flex-col items-center justify-center space-y-8 py-24 text-center md:py-32 mx-auto">
      <div className="space-y-4">
        <h1 className="text-4xl font-bold tracking-tight text-transparent sm:text-5xl md:text-6xl lg:text-7xl text-gray-900">
        Payroll Made Simple  WhatsApp
          <br />
           Payslips in One Click
        </h1>
        <p className="mx-auto max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8 text-900">
